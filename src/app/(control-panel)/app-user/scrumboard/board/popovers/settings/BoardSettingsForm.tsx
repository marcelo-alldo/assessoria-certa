...
import { ScrumboardBoard, useDeleteScrumboardBoardMutation, useUpdateScrumboardBoardMutation } from '../../../ScrumboardApi';
...
function BoardSettingsForm(props: BoardSettingsFormProps) {
  ...
  return (
    <div className="relative w-full">
      <IconButton className="absolute top-0 right-0 z-10" onClick={onClose} color="inherit" size="small">
      ...
      <List className="pt-8">
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <ListItem>
              <ListItemIcon className="min-w-9">
                <FuseSvgIcon>{value ? 'heroicons-outline:eye' : 'heroicons-outline:eye-slash'}</FuseSvgIcon>
              </ListItemIcon>
