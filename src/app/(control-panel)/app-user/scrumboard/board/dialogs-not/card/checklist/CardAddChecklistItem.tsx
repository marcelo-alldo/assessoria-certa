    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <ListItem className="px-0" dense>
        ...
        <Controller
          ...
          control={control}
          defaultValue=""
          render={({ field }) => <TextField {...field} className="flex flex-1 mx-2" name="name" variant="outlined" placeholder="Add an item" />}
        />
        <Fab className="mx-1" aria-label="Add" size="small" color="secondary" type="submit" disabled={_.isEmpty(dirtyFields) || !isValid}>
