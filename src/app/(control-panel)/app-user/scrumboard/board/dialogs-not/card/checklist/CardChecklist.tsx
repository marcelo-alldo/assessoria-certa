  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mt-4 mb-3">
        ...
        <div>
          <IconButton aria-owns={anchorEl ? 'actions-menu' : null} aria-haspopup="true" onClick={handleMenuOpen} size="small">
      ...
      <div>
        <div className="flex items-center -mx-1.5">
          <Typography className="flex font-semibold mx-1.5">{`${checkItemsChecked()} / ${form.checkItems.length}`}</Typography>
          <LinearProgress
