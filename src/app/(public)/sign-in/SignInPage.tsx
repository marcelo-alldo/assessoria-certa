    ...
    <div className="flex min-w-0 flex-1 flex-col items-center sm:flex-row sm:justify-center md:items-start md:justify-start">
      <Paper className="h-full w-full px-4 py-2 ltr:border-r-1 rtl:border-l-1 sm:h-auto sm:w-auto sm:rounded-xl sm:p-12 sm:shadow-sm md:flex md:h-full md:w-1/2 md:items-center md:justify-end md:rounded-none md:p-16 md:shadow-none">
        <CardContent className="mx-auto w-full max-w-80 sm:mx-0 sm:w-80">
          ...
          <div className="mt-0.5 flex items-baseline font-medium">
            <Typography>Não tem sua conta?</Typography>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl">
          <div className="text-5xl font-bold leading-none" style={{ color: 'white' }}>
            <div>Assessoria Certa - Seu assessor de gabinete com inteligência artificial</div>
          ...
          <div className="mt-6 text-lg leading-6 tracking-tight" style={{ color: theme.palette.secondary.main }}>
            CRM integrado oficialmente ao WhatsApp, automatize mensagens e potencialize sua campanha em até 300%.
          </div>
