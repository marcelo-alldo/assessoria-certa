...
export const themesConfig: FuseThemesType = {
  default: {
    palette: {
      ...
      primary: {
        light: '#333333', // tom mais claro de preto
        main: '#000000', // permanece preto
        dark: '#000000', // preto já é o mais escuro possível
        contrastText: '#FFFFFF',
      },
      secondary: {
  ...
  eagles: {
    palette: {
      ...
      secondary: {
        light: '#5C8CFF', // tom mais claro do azul principal
        main: '#1156ff', // azul principal
        dark: '#0037b3', // tom mais escuro do azul principal
        contrastText: '#ffffff', // branco para contraste
      },
      background: {
        paper: '#F4F4F4',
        default: '#E8E8E8',
